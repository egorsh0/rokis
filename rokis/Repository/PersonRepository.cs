...
public class PersonRepository : IPersonRepository
{
    ...
    public PersonRepository(RokisContext rokisContext, UserManager<ApplicationUser> userManager)
    {
    ...
    public Task<PersonProfile?> GetPersonAsync(string personUserId) =>
        _rokisContext.PersonProfiles.FirstOrDefaultAsync(pp => pp.UserId == personUserId);
